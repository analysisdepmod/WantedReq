namespace WantedRec.Server.Interfaces
{
    ...
    public enum PersonSecurityStatus
    {
        طبيعي = 0,
        مشتبه_به = 1,
        مطلوب = 2,
