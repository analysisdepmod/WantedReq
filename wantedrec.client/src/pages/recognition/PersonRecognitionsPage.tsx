...
import {
    ...
    AimOutlined, RadarChartOutlined, LinkOutlined, MonitorOutlined,
        ...
        >
            ...
            >
                ...
                {cameras.map((cam, i) => {
                    ...
                    return (
                        <g key={cam.id} style={{ animation: `nodeIn .4s ease ${i * 0.1}s both` }}>
                            <circle
                                cx={cam.x}
                                cy={cam.y}
                                r={18}
                            ...
                            <text
                                ...
                                textAnchor="middle"
                                fontSize={13}
                                fill={isLast || isFirst ? '#fff' : '#2563eb'}
                            >
                                📷
                            </text>
...
export default function PersonRecognitionsPage() {
    ...
    const columns: ColumnsType<RecognitionDto> = [
        ...
        },
        {
            ...
            sorter: (a, b) =>
                new Date(a.recognitionDateTime).getTime() - new Date(b.recognitionDateTime).getTime(),
            render: (_, r) => (
                <div>
    ...
    const primaryImg =
        person?.faceImages?.find((f: any) => f.isPrimary)?.faceProcessedImage ??
                    ...
                    <Alert
                        ...
                        description={
                            <Space direction="vertical" size={8}>
                                <Text>
                                    إذا كانت نتائج التعرف المحلية لا تظهر كما تتوقع، افتح صفحة المراقبة أولًا وحدد الجهاز الحالي.
                                </Text>
                                <Button
                                    size="small"
                                    type="primary"
