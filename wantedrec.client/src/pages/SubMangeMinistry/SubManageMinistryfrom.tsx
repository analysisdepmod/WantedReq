...
import { Alert, Checkbox, Col, Form, DatePicker, Input, Row, Select } from "antd";
...
import { validateArabicName, validateArabicPosition, validateEnName, validateEnPostion } from "../validate";
...
function SubManageMinistryfrom({ form, onFinish, record, btnLoading }:IForm  ) {
    ...
    useEffect(() => {
        if ((record.record.id==0)) {
            form.setFieldsValue({} as SubMangeMinistrysDto)
    ...
    return (
        <>
            ...
            <Form form={form} name="trigger" onFinish={onFinish} initialValues={ record}    autoComplete="off" layout="vertical">
                <Row className="m-1">
...
export default SubManageMinistryfrom;